...
func TestResourceAuthorizationHandled(t *testing.T) {
	for _, tc := range []struct {
		...
		{"system default deletion denied", "DELETE", "/buildresourceconfigs/default", "ebs:system", true, true},
		{"ops resource update", "PUT", "/buildresourceconfigs/default", "ebs:ops", true, false},
		{"project-scoped resource denied", "GET", "/projects/p/buildresourceconfigs/default", "ebs:admin", true, true},
