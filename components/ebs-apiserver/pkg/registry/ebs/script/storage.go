...
func NewStorage(scheme *runtime.Scheme) *Storage {
	...
	store := &genericregistry.Store{
		NewFunc:                   func() runtime.Object { return &ebsv1.Script{} },
		NewListFunc:               func() runtime.Object { return &ebsv1.ScriptList{} },
		DefaultQualifiedResource:  ebsv1.Resource("scripts"),
		SingularQualifiedResource: ebsv1.Resource("script"),
		CreateStrategy:            strategy,
		UpdateStrategy:            strategy,
		DeleteStrategy:            strategy,
		TableConvertor:            rest.NewDefaultTableConvertor(ebsv1.Resource("scripts")),
	}
...
func (s *strategy) Validate(ctx context.Context, obj runtime.Object) field.ErrorList {
	return validation.ValidateScript(obj.(*ebsv1.Script))
}
...
func (s *strategy) ObjectKinds(obj runtime.Object) ([]schema.GroupVersionKind, bool, error) {
	return []schema.GroupVersionKind{{Group: "ebs", Version: "v1", Kind: "Script"}}, false, nil
}
